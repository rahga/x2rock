...
use cli::{
    AlarmAction, AlarmsAction, BookmarksAction, Cli, Command, QueueAction, RateDirection, RawScope,
    RawTransport, UpnpScope,
};
use commands::admin;
use commands::{find_named, is_refusal, mmss, on_off, on_word, transition};
